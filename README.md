...
当前版本已包含可运行的 Vite 前端、FastAPI 智能问数、AIOps SQL 优化、多场景中心和知识库联调切片。“功能中心”作为 8 个模块、63 项功能的统一操作入口；智能问数现已打通数据源管理、ChatBI 对话分析、AI 图表选择、用户认可和大屏复用。真实外部 Adapter、向量库、模型网关、认证权限和持久化仍需按专项测试报告完成生产集成验收。
